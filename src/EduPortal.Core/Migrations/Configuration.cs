namespace EduPortal.Core.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<EduPortal.Core.EduPortalDbContext>
    {
        ...
        protected override void Seed(EduPortal.Core.EduPortalDbContext context)
        {
